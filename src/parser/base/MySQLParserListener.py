...
class MySQLParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MySQLParser#stat.
    def enterStat(self, ctx):
        pass

    # Exit a parse tree produced by MySQLParser#stat.
    ...
    # Enter a parse tree produced by MySQLParser#desc_clause.
    def enterDesc_clause(self, ctx):
        pass

    # Exit a parse tree produced by MySQLParser#desc_clause.
    def exitDesc_clause(self, ctx):
        pass


    # Enter a parse tree produced by MySQLParser#select_clause.
    def enterSelect_clause(self, ctx):
        pass

    # Exit a parse tree produced by MySQLParser#select_clause.
    ...
    # Enter a parse tree produced by MySQLParser#column_name_alias.
    def enterColumn_name_alias(self, ctx):
        pass

    # Exit a parse tree produced by MySQLParser#column_name_alias.
    def exitColumn_name_alias(self, ctx):
        pass


    # Enter a parse tree produced by MySQLParser#column_list_clause.
    def enterColumn_list_clause(self, ctx):
        pass

    # Exit a parse tree produced by MySQLParser#column_list_clause.
    def exitColumn_list_clause(self, ctx):
        pass


    # Enter a parse tree produced by MySQLParser#single_column.
    def enterSingle_column(self, ctx):
        pass

    # Exit a parse tree produced by MySQLParser#single_column.
    def exitSingle_column(self, ctx):
        pass


    # Enter a parse tree produced by MySQLParser#multi_column.
    def enterMulti_column(self, ctx):
        pass

    # Exit a parse tree produced by MySQLParser#multi_column.
    def exitMulti_column(self, ctx):
        pass


    # Enter a parse tree produced by MySQLParser#all_column.
    def enterAll_column(self, ctx):
        pass

    # Exit a parse tree produced by MySQLParser#all_column.
    def exitAll_column(self, ctx):
        pass
    ...
    # Enter a parse tree produced by MySQLParser#expr_op.
    def enterExpr_op(self, ctx):
        pass

    # Exit a parse tree produced by MySQLParser#expr_op.
    def exitExpr_op(self, ctx):
        pass


    # Enter a parse tree produced by MySQLParser#between_op.
    def enterBetween_op(self, ctx):
        pass

    # Exit a parse tree produced by MySQLParser#between_op.
    def exitBetween_op(self, ctx):
        pass


    # Enter a parse tree produced by MySQLParser#is_or_is_not.
    def enterIs_or_is_not(self, ctx):
        pass
