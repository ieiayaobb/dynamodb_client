        buf.write(u"\2^_\5\62\32\2_`\5,\27\2`\r\3\2\2\2ab\7\n\2\2bc\5.\30")
        buf.write(u"\2c\17\3\2\2\2de\7K\2\2e\21\3\2\2\2fg\7K\2\2g\23\3\2")
        buf.write(u"\2\2hi\7K\2\2i\25\3\2\2\2jn\5\30\r\2kn\5\32\16\2ln\5")
        buf.write(u"\34\17\2mj\3\2\2\2mk\3\2\2\2ml\3\2\2\2n\27\3\2\2\2op")
        buf.write(u"\7K\2\2p\31\3\2\2\2qt\7K\2\2rs\7\64\2\2su\7K\2\2tr\3")
        buf.write(u"\2\2\2uv\3\2\2\2vt\3\2\2\2vw\3\2\2\2w\33\3\2\2\2xy\7")
        buf.write(u"%\2\2y\35\3\2\2\2z}\5 \21\2{}\5\"\22\2|z\3\2\2\2|{\3")
        buf.write(u"\2\2\2}\37\3\2\2\2~\177\7\t\2\2\177\u0080\5$\23\2\u0080")
        buf.write(u"\u0081\5\62\32\2\u0081\u0082\5(\25\2\u0082!\3\2\2\2\u0083")
        buf.write(u"\u0084\7\t\2\2\u0084\u0085\5$\23\2\u0085\u0086\5\62\32")
        buf.write(u"\2\u0086\u0087\5(\25\2\u0087\u0088\5\64\33\2\u0088\u0089")
        buf.write(u"\5&\24\2\u0089\u008a\5\62\32\2\u008a\u008b\5*\26\2\u008b")
        buf.write(u"#\3\2\2\2\u008c\u008d\7K\2\2\u008d%\3\2\2\2\u008e\u008f")
        buf.write(u"\7K\2\2\u008f\'\3\2\2\2\u0090\u0091\7K\2\2\u0091)\3\2")
        buf.write(u"\2\2\u0092\u0093\7K\2\2\u0093+\3\2\2\2\u0094\u0095\7")
        buf.write(u"K\2\2\u0095-\3\2\2\2\u0096\u0097\7K\2\2\u0097/\3\2\2")
        buf.write(u"\2\u0098\u0099\t\2\2\2\u0099\61\3\2\2\2\u009a\u009b\7")
        buf.write(u",\2\2\u009b\63\3\2\2\2\u009c\u009d\t\3\2\2\u009d\65\3")
        buf.write(u"\2\2\2\u009e\u009f\7\31\2\2\u009f\67\3\2\2\2\u00a0\u00a4")
        buf.write(u"\7\16\2\2\u00a1\u00a2\7\16\2\2\u00a2\u00a4\7\60\2\2\u00a3")
        buf.write(u"\u00a0\3\2\2\2\u00a3\u00a1\3\2\2\2\u00a49\3\2\2\2\13")
        buf.write(u"=ILTYmv|\u00a3")
        return buf.getvalue()
...
class MySQLParser ( Parser ):
    ...
    RULE_table_name = 7
    RULE_column_name = 8
    RULE_column_name_alias = 9
    RULE_column_list_clause = 10
    RULE_single_column = 11
    RULE_multi_column = 12
    RULE_all_column = 13
    RULE_where_clause = 14
    RULE_hash_expression = 15
    RULE_hash_range_expression = 16
    RULE_hash_key = 17
    RULE_range_key = 18
    RULE_hash_value = 19
    RULE_range_value = 20
    RULE_insert_value = 21
    RULE_limit_value = 22
    RULE_relational_op = 23
    RULE_eq_op = 24
    RULE_expr_op = 25
    RULE_between_op = 26
    RULE_is_or_is_not = 27

    ruleNames =  [ u"stat", u"schema_name", u"desc_clause", u"select_clause", 
                   u"insert_clause", u"insert_expression", u"limit_clause", 
                   ...
                   u"insert_value", u"limit_value", u"relational_op", u"eq_op", 
    ...
    def limit_clause(self):
        ...
        self.enterRule(localctx, 12, self.RULE_limit_clause)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 95
    ...
    def table_name(self):
        ...
        self.enterRule(localctx, 14, self.RULE_table_name)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 98
            self.match(MySQLParser.ID)
    ...
    def column_name_alias(self):
        ...
        self.enterRule(localctx, 18, self.RULE_column_name_alias)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 102
            self.match(MySQLParser.ID)
    ...
    def column_list_clause(self):
        ...
        self.enterRule(localctx, 20, self.RULE_column_list_clause)
        try:
            self.state = 107
            self._errHandler.sync(self);
    ...
    def single_column(self):
        ...
        self.enterRule(localctx, 22, self.RULE_single_column)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 109
            self.match(MySQLParser.ID)
    ...
    def multi_column(self):
        ...
        self.enterRule(localctx, 24, self.RULE_multi_column)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 111
    ...
    def all_column(self):
        ...
        self.enterRule(localctx, 26, self.RULE_all_column)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 118
    ...
    def hash_expression(self):
        ...
        self.enterRule(localctx, 30, self.RULE_hash_expression)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 124
    ...
    def hash_range_expression(self):
        ...
        self.enterRule(localctx, 32, self.RULE_hash_range_expression)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 129
            self.match(MySQLParser.WHERE)
    ...
    def hash_key(self):
        ...
        self.enterRule(localctx, 34, self.RULE_hash_key)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 138
            self.match(MySQLParser.ID)
    ...
    def range_key(self):
        ...
        self.enterRule(localctx, 36, self.RULE_range_key)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 140
            self.match(MySQLParser.ID)
    ...
    def hash_value(self):
        ...
        self.enterRule(localctx, 38, self.RULE_hash_value)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 142
            self.match(MySQLParser.ID)
    ...
    def range_value(self):
        ...
        self.enterRule(localctx, 40, self.RULE_range_value)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 144
            self.match(MySQLParser.ID)
    ...
    def insert_value(self):
        ...
        self.enterRule(localctx, 42, self.RULE_insert_value)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 146
            self.match(MySQLParser.ID)
    ...
    def limit_value(self):
        ...
        self.enterRule(localctx, 44, self.RULE_limit_value)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 148
            self.match(MySQLParser.ID)
    ...
    def relational_op(self):
        ...
        self.enterRule(localctx, 46, self.RULE_relational_op)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 150
    ...
    def expr_op(self):
        ...
        self.enterRule(localctx, 50, self.RULE_expr_op)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 154
    ...
    def between_op(self):
        ...
        self.enterRule(localctx, 52, self.RULE_between_op)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 156
    ...
    def is_or_is_not(self):
        ...
        self.enterRule(localctx, 54, self.RULE_is_or_is_not)
        try:
            self.state = 161
            self._errHandler.sync(self);
